...
import { nav, navigationRef } from '../../app/navigation/navigationRef'
    ...
    >
      ...
      {open && (
        <View
          style={{
            ...
            elevation: 8,
            borderWidth: devActive ? 1 : 0,
            borderColor: devActive ? '#C4B5FD' : 'transparent',
          }}
        >
          <View
            style={{
          ...
          >
            <View
              style={{
                ...
                height: 8,
                borderRadius: 4,
                backgroundColor: isGuest ? '#EA580C' : '#10B981',
              }}
            />
            ...
            {devActive && (
              ...
              >
                <Text
                  style={{ color: '#6D28D9', fontSize: 11, fontWeight: '700' }}
                >
                  DEV:mock
                </Text>
              </View>
          ...
          <View style={{ paddingHorizontal: 8 }}>
            ...
            />
            <MenuItem
              label="Go to Tabs (Home)"
              onPress={resetTo({ index: 0, routes: [{ name: 'AppTabs' }] })}
            />
            <MenuItem
              label="Go to Launch"
              onPress={resetTo({ index: 0, routes: [{ name: 'Launch' }] })}
            />
          </View>
        </View>
      )}
      ...
      <Pressable
        ...
        style={({ pressed }) => ({
          ...
          elevation: 3,
          borderWidth: devActive ? 1 : 0,
          borderColor: devActive ? '#7C3AED' : 'transparent',
        })}
      >
        <View
          style={{
