    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Animated.View entering={FadeInUp.duration(700)}>
        ...
        <Text style={styles.subheading}>
          Before you continue, we want to ensure you understand how this app works.
        </Text>
      </Animated.View>
      ...
      <Animated.View entering={FadeInUp.delay(150)} style={styles.box}>
        <Text style={styles.text}>
          **Kete o te Mātauranga** helps you track, manage, and understand your 
          hauora using tools grounded in mātauranga Māori and modern health practice.
        </Text>
        ...
        <Text style={styles.text}>
          Your data is **private**, **not sold**, and **only used to support your wellbeing**.
        </Text>

        <Text style={styles.text}>
          You can request a copy of your data or delete it at any time in the settings.
        </Text>
      </Animated.View>
