...
export default function WelcomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      {/* Body Text */}
      <Animated.View entering={FadeInUp.delay(200).duration(700)} style={styles.bodyBox}>
        <Text style={styles.bodyText}>
          Kete o te Mātauranga is your personal wellbeing companion — guided by 
          mātauranga Māori, science, and whānau-centred care.
        </Text>
        <Text style={styles.bodyText}>
          Here, your hauora is respected, protected, and uplifted.  
          Each tool in this kete is designed to help you navigate your own 
          pathway with clarity, strength, and support.
        </Text>
      </Animated.View>
