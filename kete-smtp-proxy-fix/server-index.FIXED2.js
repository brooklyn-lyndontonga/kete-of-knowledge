...
import { ensureBetaContent } from "./scripts/beta-seed.js"
...
const app = express()
// Railway terminates TLS at its proxy and forwards X-Forwarded-For.
// Express must trust that hop or express-rate-limit throws
// ERR_ERL_UNEXPECTED_X_FORWARDED_FOR and per-user rate limiting breaks.
...
// Init DB + schema
await initSchema()
await ensureBetaContent() // TEMP: remove before store submission (real content via admin)
